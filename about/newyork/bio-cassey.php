        ...
        <div id="text">
          ...
          <div class="bio-teaser last">
            ...
            <div class="teaser-text">
              ...
              <p>Dianna&rsquo;s extensive education and training in a widespread arena of topics, including everything from architecture, construction, real estate, and negotiating, allows her to take the lead in any situation, and makes her an incredible asset to any team she joins. </p>
<div class="rule"></div>
              <h5>Professional Affiliations:</h5>
              <ul class="list">
                <li>
                  <p>American Institute of Architects – Board of Directors, Atlanta Chapter</p>
                </li>
                <li>
                  <p>Georgia Architects Association</p>
                </li>
                <li>
                  <p>National Organization of Minority Architects – Philadelphia Chapter</p>
                </li>
                <li>
                  <p>USGBC</p>
                </li>
              ...
              <h5>Education:</h5>
              <ul class="list">
                <li>Southern University  A&M College, BA Architecture</li>
                <li>Licensed Real Estate Agent</li>
              </ul>
              <h5>Training Courses:</h5>
              <ul class="list">
                <li>
                  <p>OSHA – 30 Hour Card</p>
                </li>
                <li>
                  <p>Mold Awareness</p>
                </li>
                ...
                <li>
                  <p>Negotiation Fundamentals: Negotiating Basics &amp; Negotiating Like an Expert</p>
                </li>
                <li>
                  <p>Harassment Avoidance Training for the Construction Industry</p>
                </li>
              </ul>
              <p>&nbsp;</p>
            </div>
