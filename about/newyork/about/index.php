      ...
      <div id="content-main">
        ...
        <div id="text">
          ...
          <table width="625" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left" valign="top"><p>NorthStar Museums serves as the primary liaison between a museum and the many different partners involved throughout the design and build process. We make certain that:</p>
                <ul class="list">
                  <li>The vision      for the museum is translated into a strong, written plan.</li>
                  <li>The      right team members – construction firm, engineering firm, exhibit      designers, exhibit fabricators, architects, etc. – and staff are selected.</li>
                  <li>The project is successfully completed to the visionaries’ satisfaction.</li>
              </ul></td>
              <td width="340" align="right" valign="top"><object width="320" height="240">
                <param name="movie" value="http://www.youtube.com/v/A6_M-XWidIk&amp;hl=en_US&amp;fs=1&amp;" />
                </param>
                <param name="allowFullScreen" value="true" />
                </param>
                <param name="allowscriptaccess" value="always" />
                </param>
                <embed src="http://www.youtube.com/v/A6_M-XWidIk&amp;hl=en_US&amp;fs=1&amp;" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="320" height="240"></embed>
              </object></td>
            </tr>
          </table>
<div class="rule"></div>
          <h3>A Specialized Focus</h3>
          <p>At NorthStar Museums, we know that museums are unlike any other structure. We understand that the integrity of your mission is as critical as the selection of the right team members. We appreciate the important differences between art museums and children’s museums.</p>
          <p>Put your project in the hands of an experienced firm that specializes in turning passionate ideas into compelling museums. </p>
          <div class="rule"></div>
          ...
          <div class="teaser">
            ...
            <div class="teaser-text">
              ...
              <p class="link-color"><a href="bio-street.php">Read full bio</a> »</p>
            </div>
            <div class="clear"></div>
          </div>
          <div class="teaser">
            ...
            <div class="teaser-text">
              ...
              <p class="link-color"><a href="bio-harvey.php">Read full bio</a> »</p>
            </div>
            <div class="clear"></div>
          </div>
         ...
         <div class="teaser last">
          <div class="teaser-photo"><a href="bio-wilson.php"><img src="../../images/bio-wilson.jpg" alt="Joseph Wilson" width="100" height="100" /></a><a href="bio-wilson.php"></a></div>
            <div class="teaser-text">
              ...
              <p class="link-color"><a href="bio-wilson.php">Read full bio</a> »</p>
                        </div>
        <div class="clear"></div>
          </div>
